...
--volume $PWD:/tmp \
docker.elastic.co/beats/filebeat:7.1.0 \
...
```
docker container run --name filebeat --rm --network host --volume filebeat:/usr/share/filebeat/data --volume $PWD:/tmp docker.elastic.co/beats/filebeat:7.1.0 \
